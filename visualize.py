...
use_cuda = torch.cuda.is_available() && opt.gpu

raw_img = io.imread(opt.input if opt.input else 'images/1.jpg')
gray = rgb2gray(raw_img)
gray = resize(gray, (cut_size+4,cut_size+4), mode='symmetric').astype(np.uint8)
